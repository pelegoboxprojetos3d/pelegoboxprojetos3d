...
.playbox{grid-template-rows:27px minmax(0,1fr)!important;margin-top:-27px!important;height:calc(100% + 27px)!important}.playbody{padding:6px 14px 10px!important;grid-template-rows:12px 28px 22px 44px minmax(18px,1fr) 34px!important;gap:3px!important}.label{font-size:9px!important}.playbody select{height:28px!important;font-size:10px!important}.volrow{grid-template-columns:22px minmax(0,1fr) 36px!important;font-size:9px!important}.randomrow{gap:14px!important}.randomrow label{grid-template-rows:12px 28px!important}.randomrow label:first-child .label{background:#049a32!important;border:1px solid #16d954!important;text-align:center!important;padding-top:1px!important}.randomrow .label{font-size:8px!important}.hint{font-size:9px!important;line-height:11px!important;color:#fff!important;font-weight:500!important;white-space:normal!important;overflow:hidden!important;text-overflow:clip!important;padding-top:1px!important}.controls{gap:12px!important}.controls button{height:34px!important;font-size:11px!important;border-radius:5px!important}.controls .play{background:linear-gradient(#0fc14a,#087f31)!important}.controls .stop{background:linear-gradient(#d73931,#9b1c17)!important}
