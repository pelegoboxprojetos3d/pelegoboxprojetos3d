...
rep(
  ...
  ".eqgrid{min-width:0!important;width:100%!important;grid-template-columns:repeat(6,minmax(0,1fr))!important;gap:0!important;padding:2px 0 0 30px!important;overflow:hidden!important;align-items:stretch!important;justify-content:stretch!important}.eqgrid .band{justify-items:center!important}",
...
rep("'20260821-mobile-final-v3'","'20260821-mobile-final-v4'",'revisao da skin mobile');
fs.writeFileSync(path,s);
console.log('OK: equalizador distribuido em 6 colunas iguais e TOCANDO agrupado a esquerda');