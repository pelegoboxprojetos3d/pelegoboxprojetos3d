...
.playbox{grid-template-rows:27px minmax(0,1fr)!important;margin-top:-7px!important;height:calc(100% + 7px)!important}.playbody{padding:0 14px 10px!important;grid-template-rows:9px 23px 18px 32px 8px 27px!important;gap:1px!important}.label{font-size:8px!important}.playbody select{height:23px!important;font-size:9px!important}.volrow{grid-template-columns:22px minmax(0,1fr) 32px!important;font-size:8px!important}.randomrow{gap:14px!important}.randomrow label{grid-template-rows:9px 21px!important}.randomrow label:first-child .label{background:#049a32!important;border:1px solid #16d954!important;text-align:center!important;padding-top:1px!important}.randomrow .label{font-size:7px!important}.hint{font-size:8.5px!important;line-height:8px!important;color:#fff!important;font-weight:500!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}.controls{gap:12px!important}.controls button{height:27px!important;font-size:10px!important;border-radius:5px!important}.controls .play{background:linear-gradient(#0fc14a,#087f31)!important}.controls .stop{background:linear-gradient(#d73931,#9b1c17)!important}
