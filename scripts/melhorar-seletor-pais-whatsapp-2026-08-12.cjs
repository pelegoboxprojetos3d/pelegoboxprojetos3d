...
// Troca os selects nativos por estado oculto. A UI passa a ser o seletor completo
// renderizado pela biblioteca junto do próprio campo de telefone.
...
// Layout e tamanho visual. A bandeira selecionada fica realmente legível.
...
// O código antigo tentava hidratar um <select>. Agora usamos o país/ISO salvo
// diretamente e sincronizamos a UI internacional.
...
// Injeta a inicialização após o mapa de elementos da UI.
...
// Os listeners antigos dos selects ocultos continuam inofensivos, mas garantimos
// que qualquer mudança programática também mantenha os dois estados iguais.
